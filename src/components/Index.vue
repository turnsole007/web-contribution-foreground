          ...
          <el-col :span="6">
            <el-card :body-style="{ padding: '0px'}">
              ...
              <div style="padding: 14px;">
                ...
                <div class="bottom clearfix">
                  <a href="https://www.oschina.net/news/112177/open-source-in-2020-the-future-looks-bright?utm_source=wechat&utm_medium=zaobao">详情请戳</a>
                </div>
              </div>
            </el-card>
          </el-col>
...
export default {
  ...
  data () {
    return {
      ...
      msg: 'Welcome to web-contribution',
      username: '',
      isLogin: true
    }
  },
